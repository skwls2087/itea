...
<<<<<<< Updated upstream:itea/src/main/webapp/WEB-INF/views/member/loginFrm.jsp
		  <!-- 2.카카오 -->  
...
=======
		 ...
		 <!-- 4.페이스북 -->
>>>>>>> Stashed changes:itea-elludiana/src/main/webapp/WEB-INF/views/member/loginFrm.jsp
